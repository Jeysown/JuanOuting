                        ...
                        <div class="container" id="book">
                          ...
                          <div class="search-bar">
                            <div class="search-content search-location-responsive sticky-button-book" >
                                <button class="subscribe btn btn-primary btn-lg btn-block" type="button" onClick="openSearch()">Book Now</button>
                            </div>
                            <div class="overlay overlay-search" id="mySearch">
                              <div class="overlay-content overlay-content-book" id="content-search">
                                <div class=" search-bar">
