<html>
    ...
    <script>
       ...
       function changeMonth() {
        var selectBox = document.getElementById("birthMonth");
        var selectedValue = selectBox.options[selectBox.selectedIndex].value;
        if(selectedValue == 2){
          var changeDay = document.getElementById("birthDay");
          $('#birthDay').children('option:not(:first)').remove();
          for (var i = 1; i < 29; i++) {
            changeDay.options[changeDay.options.length] = new Option(''+i);
          }
        }
       ...
       function changeLeap(){
         ...
         else if((yearValue % 400 == 0) || ((yearValue % 4 == 0) && (yearValue % 100 != 0))){
           var selectBox = document.getElementById("birthMonth");
           var selectedValue = selectBox.options[selectBox.selectedIndex].value;
           if(selectedValue == 2){
             var changeDay = document.getElementById("birthDay");
    ...
    <body>
      ...
      <select id="birthMonth" name="birthMonth" onchange="changeLeap();">
...
<select id="birthYear" name="birthYear" onchange="changeLeap()">
