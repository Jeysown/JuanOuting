  ...
  <div class="container">
    ...
    <div class="col-md-7"style="padding-bottom:50px;">
      <div class="col-lg-10">
      <center><h3 style="padding:0px 30px;">Let us include some rules for your resort!</h3></center>
      </div>
            ...
            <div class="col-xs-12">
                <div class="form-group">
                    <div class="has-feedback">
                      <textarea class="form-control" rows="5" placeholder="More rules for your Private Pool" style="resize:vertical;"></textarea>
                    </div>
                </div>
            </div>
        </div>
